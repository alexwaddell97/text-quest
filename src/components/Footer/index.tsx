...
export default function Footer() {
    return (
        ...
        >
            <div className="pointer-events-none absolute inset-x-0 -top-16 mx-auto h-24 w-3/4 rounded-full bg-gradient-to-r from-rose-500/20 via-amber-300/10 to-red-800/20 blur-3xl" aria-hidden />
            ...
            <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-6 py-10 md:flex-row md:items-start md:justify-between">
                <div className="space-y-4 max-w-sm">
                    <div className="flex items-center gap-3">
                        <Image src="/logo.svg" alt="Roleplaying Realm logo" width={36} height={36} />
                        <div>
